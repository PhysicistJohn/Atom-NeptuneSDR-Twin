...
| `deps/firmwave.lock.json` | Public Firmwave repository URL, full commit/tree identity, and canonical interface SHA-256 | Correctness of Firmwave, seller authorship, or hardware compatibility |
| [`Atom-NeptuneSDR_Firmwave`](https://github.com/PhysicistJohn/Atom-NeptuneSDR_Firmwave) input/runtime locks and manifest | URL, size and SHA-256 for pinned public inputs; audited structure; exact source identity; hashes for every emitted `qemu-development` artifact | Vendor authorship, authenticity, freedom from defects, safe flashability, or compatibility with this revision |
...
- [ADI Pluto firmware repository](https://github.com/analogdevicesinc/plutosdr-fw/tree/v0.39): source/build topology and v0.39 release inputs. Firmwave's input lock records the release archive digest.
...
- [Pinned public P210 SD boot artifact](https://github.com/wucke13/Neptune-SDR-nix-utils/tree/ba4a958333a3dfec5e5102e30fe017508e1fd6f6): third-party artifact referenced by Firmwave's input lock. Its SHA-256 protects the bytes used by tests.
...
- A full E3 acceptance result binds the Twin and Firmwave commit/tree/source-state
